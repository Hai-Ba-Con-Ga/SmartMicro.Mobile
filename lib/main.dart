...
import 'package:material_3_demo/screens/home_screen.dart';
...
class _AppState extends State<App> {
  ...
  bool get useLightMode => switch (themeMode) { ThemeMode.system => View.of(context).platformDispatcher.platformBrightness == Brightness.light, ThemeMode.light => true, ThemeMode.dark => false };
