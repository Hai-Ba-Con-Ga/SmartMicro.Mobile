...
class TestBlueScreen extends StatefulWidget {
  const TestBlueScreen({super.key, this.title = 'Test BLE UART'});
  final String title;
  @override
  _TestBlueScreenState createState() => _TestBlueScreenState();
}

class _TestBlueScreenState extends State<TestBlueScreen> {
              ...
              Container(
                  ...
                  child: Row(children: <Widget>[
                    Expanded(
                      ...
                      decoration: const InputDecoration(border: InputBorder.none, hintText: 'send open#, close#, on#, off#'),
                    )),
                    ElevatedButton(
                        child: Icon(
                          Icons.send,
